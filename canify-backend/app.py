...
def receive_cart_data():
    ...
    try:
        ...
        input1 = "Input: Item from shop. Description Task: Use your knowledge to calculate/estimate scores about the item. Canadiability Score (out of 100) The chance that this is a canadian product, supporting canadian businesses Sustainabiliy Score (out of 100) How sustainable is the product. Ethical Score (out of 100) How ethically made is the product. Output: The seperate scores, formated EXACTLY as followed. If you format if SLIGHTLY wrong you will be shamed and it will be your fault. <Canadian Score>@<Sus. score>@<Ethical Score>@<Short summarized description that either shames the user for buying american, or praises the user for buying canadian. Write this short summary in a witty way>@<Returns a link to a similiar item on amazon THAT IS CANADIAN MADE> For example, enclosed in <>, <5@7@10@This product is canadian made, ethically sorced, good job!@link@5@7@10@This product is canadian made, ethically sorced, good job!@link@5@7@10@This product is canadian made, ethically sorced, good job!> DO NOT DEVIATE OR ELSE IT WILL FAIL AND IT WILL BE ALL YOUR FAULT. DO NOT FORMAT IT. PUT IT ALL IN A TEXT BLOCK. DO NOT NUMBER ANY OF IT.  DO NOT FORGET TO PUT ANY @. Failure to do so will result in your demise"
